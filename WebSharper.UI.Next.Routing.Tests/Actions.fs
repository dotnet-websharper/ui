...
*)
    ...
    type RouterTests =
        ...
        | CSharpInferred of WebSharper.UI.Next.CSharp.Routing.Tests.Root
    ...
    let routerTests =
        Router.Sum [
            ...
            "csharp-inferred" / WebSharper.UI.Next.CSharp.Routing.Tests.Root.Inferred |> Router.MapInto CSharpInferred (function CSharpInferred t -> Some t | _ -> None) 
        ]
