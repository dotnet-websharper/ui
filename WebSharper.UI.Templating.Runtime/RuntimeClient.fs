                    ...
                    | Server.ValTy.DomElement ->
                        Server.TemplateInitializer.GetOrAddHoleFor(key, name, fun () ->
                            ...
                            if el <> null then
                                ...
                                //                            var.SetFinal None
                                //                            mo.Disconnect()
                                //                        elif mr.AddedNodes.Length = 1 && x !==. (mr.AddedNodes[0] :?> Dom.Element) then
                                //                            var.Set (Some (mr.AddedNodes[0] :?> Dom.Element))
                                //                    ), null)
                                //                )
                                //            )
                                //        )
                                ...
                                //        | Some nel ->
                                //            if toWatch ===. nel then
                                //                //if nel.ParentElement !==. null then
                                //                //    let mo =
                                //                //        JavaScript.Dom.MutationObserver(
                                //                //            (fun (mrs, mo) ->
                                //                //                mrs
                                ...
                                //                //                            var.Set None
                                //                //                            mo.Disconnect()
                                //                //                        elif mr.AddedNodes.Length = 1 then
                                //                //                            var.Set (Some (mr.AddedNodes[0] :?> Dom.Element))
                                //                //                            mo.Disconnect()
                                //                //                    ), null)
                                //                //                )
                                //                //            )
                                //                //        )
                                //                //    mo.Observe(nel.ParentElement, Dom.MutationObserverInit(ChildList = true))
                                //                ()
                                //            else
