...
type on =
    ...
    [<JavaScript; Inline>]
    static member abort (f: System.Action<Dom.Element, Dom.UIEvent>) = Client.Attr.Handler "abort" (FSharpConvert.Fun f)
    /// Create a handler for the event "abort" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member abortView (view: View<'T>) (f: System.Action<Dom.Element, Dom.UIEvent, 'T>) = Client.Attr.HandlerView "abort" view (FSharpConvert.Fun f)
    /// Create a handler for the event "afterprint".
    [<JavaScript; Inline>]
    static member afterPrint (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "afterprint" (FSharpConvert.Fun f)
    /// Create a handler for the event "afterprint" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member afterPrintView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "afterprint" view (FSharpConvert.Fun f)
    /// Create a handler for the event "animationend".
    [<JavaScript; Inline>]
    static member animationEnd (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "animationend" (FSharpConvert.Fun f)
    /// Create a handler for the event "animationend" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member animationEndView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "animationend" view (FSharpConvert.Fun f)
    /// Create a handler for the event "animationiteration".
    [<JavaScript; Inline>]
    static member animationIteration (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "animationiteration" (FSharpConvert.Fun f)
    /// Create a handler for the event "animationiteration" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member animationIterationView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "animationiteration" view (FSharpConvert.Fun f)
    /// Create a handler for the event "animationstart".
    [<JavaScript; Inline>]
    static member animationStart (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "animationstart" (FSharpConvert.Fun f)
    /// Create a handler for the event "animationstart" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member animationStartView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "animationstart" view (FSharpConvert.Fun f)
    /// Create a handler for the event "audioprocess".
    [<JavaScript; Inline>]
    static member audioProcess (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "audioprocess" (FSharpConvert.Fun f)
    /// Create a handler for the event "audioprocess" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member audioProcessView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "audioprocess" view (FSharpConvert.Fun f)
    /// Create a handler for the event "beforeprint".
    [<JavaScript; Inline>]
    static member beforePrint (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "beforeprint" (FSharpConvert.Fun f)
    /// Create a handler for the event "beforeprint" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member beforePrintView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "beforeprint" view (FSharpConvert.Fun f)
    /// Create a handler for the event "beforeunload".
    [<JavaScript; Inline>]
    static member beforeUnload (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "beforeunload" (FSharpConvert.Fun f)
    /// Create a handler for the event "beforeunload" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member beforeUnloadView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "beforeunload" view (FSharpConvert.Fun f)
    /// Create a handler for the event "beginEvent".
    [<JavaScript; Inline>]
    static member beginEvent (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "beginEvent" (FSharpConvert.Fun f)
    /// Create a handler for the event "beginEvent" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member beginEventView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "beginEvent" view (FSharpConvert.Fun f)
    /// Create a handler for the event "blocked".
    [<JavaScript; Inline>]
    static member blocked (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "blocked" (FSharpConvert.Fun f)
    /// Create a handler for the event "blocked" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member blockedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "blocked" view (FSharpConvert.Fun f)
    /// Create a handler for the event "blur".
    [<JavaScript; Inline>]
    static member blur (f: System.Action<Dom.Element, Dom.FocusEvent>) = Client.Attr.Handler "blur" (FSharpConvert.Fun f)
    /// Create a handler for the event "blur" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member blurView (view: View<'T>) (f: System.Action<Dom.Element, Dom.FocusEvent, 'T>) = Client.Attr.HandlerView "blur" view (FSharpConvert.Fun f)
    /// Create a handler for the event "cached".
    [<JavaScript; Inline>]
    static member cached (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "cached" (FSharpConvert.Fun f)
    /// Create a handler for the event "cached" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member cachedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "cached" view (FSharpConvert.Fun f)
    /// Create a handler for the event "canplay".
    [<JavaScript; Inline>]
    static member canPlay (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "canplay" (FSharpConvert.Fun f)
    /// Create a handler for the event "canplay" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member canPlayView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "canplay" view (FSharpConvert.Fun f)
    /// Create a handler for the event "canplaythrough".
    [<JavaScript; Inline>]
    static member canPlayThrough (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "canplaythrough" (FSharpConvert.Fun f)
    /// Create a handler for the event "canplaythrough" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member canPlayThroughView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "canplaythrough" view (FSharpConvert.Fun f)
    /// Create a handler for the event "change".
    [<JavaScript; Inline>]
    static member change (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "change" (FSharpConvert.Fun f)
    /// Create a handler for the event "change" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member changeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "change" view (FSharpConvert.Fun f)
    /// Create a handler for the event "chargingchange".
    [<JavaScript; Inline>]
    static member chargingChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "chargingchange" (FSharpConvert.Fun f)
    /// Create a handler for the event "chargingchange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member chargingChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "chargingchange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "chargingtimechange".
    [<JavaScript; Inline>]
    static member chargingTimeChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "chargingtimechange" (FSharpConvert.Fun f)
    /// Create a handler for the event "chargingtimechange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member chargingTimeChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "chargingtimechange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "checking".
    [<JavaScript; Inline>]
    static member checking (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "checking" (FSharpConvert.Fun f)
    /// Create a handler for the event "checking" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member checkingView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "checking" view (FSharpConvert.Fun f)
    /// Create a handler for the event "click".
    [<JavaScript; Inline>]
    static member click (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "click" (FSharpConvert.Fun f)
    /// Create a handler for the event "click" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member clickView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "click" view (FSharpConvert.Fun f)
    /// Create a handler for the event "close".
    [<JavaScript; Inline>]
    static member close (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "close" (FSharpConvert.Fun f)
    /// Create a handler for the event "close" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member closeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "close" view (FSharpConvert.Fun f)
    /// Create a handler for the event "complete".
    [<JavaScript; Inline>]
    static member complete (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "complete" (FSharpConvert.Fun f)
    /// Create a handler for the event "complete" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member completeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "complete" view (FSharpConvert.Fun f)
    /// Create a handler for the event "compositionend".
    [<JavaScript; Inline>]
    static member compositionEnd (f: System.Action<Dom.Element, Dom.CompositionEvent>) = Client.Attr.Handler "compositionend" (FSharpConvert.Fun f)
    /// Create a handler for the event "compositionend" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member compositionEndView (view: View<'T>) (f: System.Action<Dom.Element, Dom.CompositionEvent, 'T>) = Client.Attr.HandlerView "compositionend" view (FSharpConvert.Fun f)
    /// Create a handler for the event "compositionstart".
    [<JavaScript; Inline>]
    static member compositionStart (f: System.Action<Dom.Element, Dom.CompositionEvent>) = Client.Attr.Handler "compositionstart" (FSharpConvert.Fun f)
    /// Create a handler for the event "compositionstart" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member compositionStartView (view: View<'T>) (f: System.Action<Dom.Element, Dom.CompositionEvent, 'T>) = Client.Attr.HandlerView "compositionstart" view (FSharpConvert.Fun f)
    /// Create a handler for the event "compositionupdate".
    [<JavaScript; Inline>]
    static member compositionUpdate (f: System.Action<Dom.Element, Dom.CompositionEvent>) = Client.Attr.Handler "compositionupdate" (FSharpConvert.Fun f)
    /// Create a handler for the event "compositionupdate" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member compositionUpdateView (view: View<'T>) (f: System.Action<Dom.Element, Dom.CompositionEvent, 'T>) = Client.Attr.HandlerView "compositionupdate" view (FSharpConvert.Fun f)
    /// Create a handler for the event "contextmenu".
    [<JavaScript; Inline>]
    static member contextMenu (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "contextmenu" (FSharpConvert.Fun f)
    /// Create a handler for the event "contextmenu" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member contextMenuView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "contextmenu" view (FSharpConvert.Fun f)
    /// Create a handler for the event "copy".
    [<JavaScript; Inline>]
    static member copy (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "copy" (FSharpConvert.Fun f)
    /// Create a handler for the event "copy" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member copyView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "copy" view (FSharpConvert.Fun f)
    /// Create a handler for the event "cut".
    [<JavaScript; Inline>]
    static member cut (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "cut" (FSharpConvert.Fun f)
    /// Create a handler for the event "cut" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member cutView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "cut" view (FSharpConvert.Fun f)
    /// Create a handler for the event "dblclick".
    [<JavaScript; Inline>]
    static member dblClick (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "dblclick" (FSharpConvert.Fun f)
    /// Create a handler for the event "dblclick" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dblClickView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "dblclick" view (FSharpConvert.Fun f)
    /// Create a handler for the event "devicelight".
    [<JavaScript; Inline>]
    static member deviceLight (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "devicelight" (FSharpConvert.Fun f)
    /// Create a handler for the event "devicelight" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member deviceLightView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "devicelight" view (FSharpConvert.Fun f)
    /// Create a handler for the event "devicemotion".
    [<JavaScript; Inline>]
    static member deviceMotion (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "devicemotion" (FSharpConvert.Fun f)
    /// Create a handler for the event "devicemotion" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member deviceMotionView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "devicemotion" view (FSharpConvert.Fun f)
    /// Create a handler for the event "deviceorientation".
    [<JavaScript; Inline>]
    static member deviceOrientation (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "deviceorientation" (FSharpConvert.Fun f)
    /// Create a handler for the event "deviceorientation" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member deviceOrientationView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "deviceorientation" view (FSharpConvert.Fun f)
    /// Create a handler for the event "deviceproximity".
    [<JavaScript; Inline>]
    static member deviceProximity (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "deviceproximity" (FSharpConvert.Fun f)
    /// Create a handler for the event "deviceproximity" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member deviceProximityView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "deviceproximity" view (FSharpConvert.Fun f)
    /// Create a handler for the event "dischargingtimechange".
    [<JavaScript; Inline>]
    static member dischargingTimeChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "dischargingtimechange" (FSharpConvert.Fun f)
    /// Create a handler for the event "dischargingtimechange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dischargingTimeChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "dischargingtimechange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMActivate".
    [<JavaScript; Inline>]
    static member DOMActivate (f: System.Action<Dom.Element, Dom.UIEvent>) = Client.Attr.Handler "DOMActivate" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMActivate" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMActivateView (view: View<'T>) (f: System.Action<Dom.Element, Dom.UIEvent, 'T>) = Client.Attr.HandlerView "DOMActivate" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMAttributeNameChanged".
    [<JavaScript; Inline>]
    static member DOMAttributeNameChanged (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "DOMAttributeNameChanged" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMAttributeNameChanged" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMAttributeNameChangedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "DOMAttributeNameChanged" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMAttrModified".
    [<JavaScript; Inline>]
    static member DOMAttrModified (f: System.Action<Dom.Element, Dom.MutationEvent>) = Client.Attr.Handler "DOMAttrModified" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMAttrModified" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMAttrModifiedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MutationEvent, 'T>) = Client.Attr.HandlerView "DOMAttrModified" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMCharacterDataModified".
    [<JavaScript; Inline>]
    static member DOMCharacterDataModified (f: System.Action<Dom.Element, Dom.MutationEvent>) = Client.Attr.Handler "DOMCharacterDataModified" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMCharacterDataModified" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMCharacterDataModifiedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MutationEvent, 'T>) = Client.Attr.HandlerView "DOMCharacterDataModified" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMContentLoaded".
    [<JavaScript; Inline>]
    static member DOMContentLoaded (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "DOMContentLoaded" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMContentLoaded" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMContentLoadedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "DOMContentLoaded" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMElementNameChanged".
    [<JavaScript; Inline>]
    static member DOMElementNameChanged (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "DOMElementNameChanged" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMElementNameChanged" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMElementNameChangedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "DOMElementNameChanged" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMNodeInserted".
    [<JavaScript; Inline>]
    static member DOMNodeInserted (f: System.Action<Dom.Element, Dom.MutationEvent>) = Client.Attr.Handler "DOMNodeInserted" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMNodeInserted" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMNodeInsertedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MutationEvent, 'T>) = Client.Attr.HandlerView "DOMNodeInserted" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMNodeInsertedIntoDocument".
    [<JavaScript; Inline>]
    static member DOMNodeInsertedIntoDocument (f: System.Action<Dom.Element, Dom.MutationEvent>) = Client.Attr.Handler "DOMNodeInsertedIntoDocument" (FSharpConvert.Fun f)
    ...
    [<JavaScript; Inline>]
    static member DOMNodeInsertedIntoDocumentView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MutationEvent, 'T>) = Client.Attr.HandlerView "DOMNodeInsertedIntoDocument" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMNodeRemoved".
    [<JavaScript; Inline>]
    static member DOMNodeRemoved (f: System.Action<Dom.Element, Dom.MutationEvent>) = Client.Attr.Handler "DOMNodeRemoved" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMNodeRemoved" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMNodeRemovedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MutationEvent, 'T>) = Client.Attr.HandlerView "DOMNodeRemoved" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMNodeRemovedFromDocument".
    [<JavaScript; Inline>]
    static member DOMNodeRemovedFromDocument (f: System.Action<Dom.Element, Dom.MutationEvent>) = Client.Attr.Handler "DOMNodeRemovedFromDocument" (FSharpConvert.Fun f)
    ...
    [<JavaScript; Inline>]
    static member DOMNodeRemovedFromDocumentView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MutationEvent, 'T>) = Client.Attr.HandlerView "DOMNodeRemovedFromDocument" view (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMSubtreeModified".
    [<JavaScript; Inline>]
    static member DOMSubtreeModified (f: System.Action<Dom.Element, Dom.MutationEvent>) = Client.Attr.Handler "DOMSubtreeModified" (FSharpConvert.Fun f)
    /// Create a handler for the event "DOMSubtreeModified" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member DOMSubtreeModifiedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MutationEvent, 'T>) = Client.Attr.HandlerView "DOMSubtreeModified" view (FSharpConvert.Fun f)
    /// Create a handler for the event "downloading".
    [<JavaScript; Inline>]
    static member downloading (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "downloading" (FSharpConvert.Fun f)
    /// Create a handler for the event "downloading" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member downloadingView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "downloading" view (FSharpConvert.Fun f)
    /// Create a handler for the event "drag".
    [<JavaScript; Inline>]
    static member drag (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "drag" (FSharpConvert.Fun f)
    /// Create a handler for the event "drag" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dragView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "drag" view (FSharpConvert.Fun f)
    /// Create a handler for the event "dragend".
    [<JavaScript; Inline>]
    static member dragEnd (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "dragend" (FSharpConvert.Fun f)
    /// Create a handler for the event "dragend" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dragEndView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "dragend" view (FSharpConvert.Fun f)
    /// Create a handler for the event "dragenter".
    [<JavaScript; Inline>]
    static member dragEnter (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "dragenter" (FSharpConvert.Fun f)
    /// Create a handler for the event "dragenter" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dragEnterView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "dragenter" view (FSharpConvert.Fun f)
    /// Create a handler for the event "dragleave".
    [<JavaScript; Inline>]
    static member dragLeave (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "dragleave" (FSharpConvert.Fun f)
    /// Create a handler for the event "dragleave" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dragLeaveView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "dragleave" view (FSharpConvert.Fun f)
    /// Create a handler for the event "dragover".
    [<JavaScript; Inline>]
    static member dragOver (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "dragover" (FSharpConvert.Fun f)
    /// Create a handler for the event "dragover" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dragOverView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "dragover" view (FSharpConvert.Fun f)
    /// Create a handler for the event "dragstart".
    [<JavaScript; Inline>]
    static member dragStart (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "dragstart" (FSharpConvert.Fun f)
    /// Create a handler for the event "dragstart" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dragStartView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "dragstart" view (FSharpConvert.Fun f)
    /// Create a handler for the event "drop".
    [<JavaScript; Inline>]
    static member drop (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "drop" (FSharpConvert.Fun f)
    /// Create a handler for the event "drop" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member dropView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "drop" view (FSharpConvert.Fun f)
    /// Create a handler for the event "durationchange".
    [<JavaScript; Inline>]
    static member durationChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "durationchange" (FSharpConvert.Fun f)
    /// Create a handler for the event "durationchange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member durationChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "durationchange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "emptied".
    [<JavaScript; Inline>]
    static member emptied (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "emptied" (FSharpConvert.Fun f)
    /// Create a handler for the event "emptied" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member emptiedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "emptied" view (FSharpConvert.Fun f)
    /// Create a handler for the event "ended".
    [<JavaScript; Inline>]
    static member ended (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "ended" (FSharpConvert.Fun f)
    /// Create a handler for the event "ended" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member endedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "ended" view (FSharpConvert.Fun f)
    /// Create a handler for the event "endEvent".
    [<JavaScript; Inline>]
    static member endEvent (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "endEvent" (FSharpConvert.Fun f)
    /// Create a handler for the event "endEvent" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member endEventView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "endEvent" view (FSharpConvert.Fun f)
    /// Create a handler for the event "error".
    [<JavaScript; Inline>]
    static member error (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "error" (FSharpConvert.Fun f)
    /// Create a handler for the event "error" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member errorView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "error" view (FSharpConvert.Fun f)
    /// Create a handler for the event "focus".
    [<JavaScript; Inline>]
    static member focus (f: System.Action<Dom.Element, Dom.FocusEvent>) = Client.Attr.Handler "focus" (FSharpConvert.Fun f)
    /// Create a handler for the event "focus" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member focusView (view: View<'T>) (f: System.Action<Dom.Element, Dom.FocusEvent, 'T>) = Client.Attr.HandlerView "focus" view (FSharpConvert.Fun f)
    /// Create a handler for the event "fullscreenchange".
    [<JavaScript; Inline>]
    static member fullScreenChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "fullscreenchange" (FSharpConvert.Fun f)
    /// Create a handler for the event "fullscreenchange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member fullScreenChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "fullscreenchange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "fullscreenerror".
    [<JavaScript; Inline>]
    static member fullScreenError (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "fullscreenerror" (FSharpConvert.Fun f)
    /// Create a handler for the event "fullscreenerror" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member fullScreenErrorView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "fullscreenerror" view (FSharpConvert.Fun f)
    /// Create a handler for the event "gamepadconnected".
    [<JavaScript; Inline>]
    static member gamepadConnected (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "gamepadconnected" (FSharpConvert.Fun f)
    /// Create a handler for the event "gamepadconnected" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member gamepadConnectedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "gamepadconnected" view (FSharpConvert.Fun f)
    /// Create a handler for the event "gamepaddisconnected".
    [<JavaScript; Inline>]
    static member gamepadDisconnected (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "gamepaddisconnected" (FSharpConvert.Fun f)
    /// Create a handler for the event "gamepaddisconnected" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member gamepadDisconnectedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "gamepaddisconnected" view (FSharpConvert.Fun f)
    /// Create a handler for the event "hashchange".
    [<JavaScript; Inline>]
    static member hashChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "hashchange" (FSharpConvert.Fun f)
    /// Create a handler for the event "hashchange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member hashChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "hashchange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "input".
    [<JavaScript; Inline>]
    static member input (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "input" (FSharpConvert.Fun f)
    /// Create a handler for the event "input" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member inputView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "input" view (FSharpConvert.Fun f)
    /// Create a handler for the event "invalid".
    [<JavaScript; Inline>]
    static member invalid (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "invalid" (FSharpConvert.Fun f)
    /// Create a handler for the event "invalid" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member invalidView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "invalid" view (FSharpConvert.Fun f)
    /// Create a handler for the event "keydown".
    [<JavaScript; Inline>]
    static member keyDown (f: System.Action<Dom.Element, Dom.KeyboardEvent>) = Client.Attr.Handler "keydown" (FSharpConvert.Fun f)
    /// Create a handler for the event "keydown" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member keyDownView (view: View<'T>) (f: System.Action<Dom.Element, Dom.KeyboardEvent, 'T>) = Client.Attr.HandlerView "keydown" view (FSharpConvert.Fun f)
    /// Create a handler for the event "keypress".
    [<JavaScript; Inline>]
    static member keyPress (f: System.Action<Dom.Element, Dom.KeyboardEvent>) = Client.Attr.Handler "keypress" (FSharpConvert.Fun f)
    /// Create a handler for the event "keypress" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member keyPressView (view: View<'T>) (f: System.Action<Dom.Element, Dom.KeyboardEvent, 'T>) = Client.Attr.HandlerView "keypress" view (FSharpConvert.Fun f)
    /// Create a handler for the event "keyup".
    [<JavaScript; Inline>]
    static member keyUp (f: System.Action<Dom.Element, Dom.KeyboardEvent>) = Client.Attr.Handler "keyup" (FSharpConvert.Fun f)
    /// Create a handler for the event "keyup" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member keyUpView (view: View<'T>) (f: System.Action<Dom.Element, Dom.KeyboardEvent, 'T>) = Client.Attr.HandlerView "keyup" view (FSharpConvert.Fun f)
    /// Create a handler for the event "languagechange".
    [<JavaScript; Inline>]
    static member languageChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "languagechange" (FSharpConvert.Fun f)
    /// Create a handler for the event "languagechange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member languageChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "languagechange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "levelchange".
    [<JavaScript; Inline>]
    static member levelChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "levelchange" (FSharpConvert.Fun f)
    /// Create a handler for the event "levelchange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member levelChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "levelchange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "load".
    [<JavaScript; Inline>]
    static member load (f: System.Action<Dom.Element, Dom.UIEvent>) = Client.Attr.Handler "load" (FSharpConvert.Fun f)
    /// Create a handler for the event "load" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member loadView (view: View<'T>) (f: System.Action<Dom.Element, Dom.UIEvent, 'T>) = Client.Attr.HandlerView "load" view (FSharpConvert.Fun f)
    /// Create a handler for the event "loadeddata".
    [<JavaScript; Inline>]
    static member loadedData (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "loadeddata" (FSharpConvert.Fun f)
    /// Create a handler for the event "loadeddata" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member loadedDataView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "loadeddata" view (FSharpConvert.Fun f)
    /// Create a handler for the event "loadedmetadata".
    [<JavaScript; Inline>]
    static member loadedMetadata (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "loadedmetadata" (FSharpConvert.Fun f)
    /// Create a handler for the event "loadedmetadata" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member loadedMetadataView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "loadedmetadata" view (FSharpConvert.Fun f)
    /// Create a handler for the event "loadend".
    [<JavaScript; Inline>]
    static member loadEnd (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "loadend" (FSharpConvert.Fun f)
    /// Create a handler for the event "loadend" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member loadEndView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "loadend" view (FSharpConvert.Fun f)
    /// Create a handler for the event "loadstart".
    [<JavaScript; Inline>]
    static member loadStart (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "loadstart" (FSharpConvert.Fun f)
    /// Create a handler for the event "loadstart" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member loadStartView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "loadstart" view (FSharpConvert.Fun f)
    /// Create a handler for the event "message".
    [<JavaScript; Inline>]
    static member message (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "message" (FSharpConvert.Fun f)
    /// Create a handler for the event "message" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member messageView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "message" view (FSharpConvert.Fun f)
    /// Create a handler for the event "mousedown".
    [<JavaScript; Inline>]
    static member mouseDown (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "mousedown" (FSharpConvert.Fun f)
    /// Create a handler for the event "mousedown" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member mouseDownView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "mousedown" view (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseenter".
    [<JavaScript; Inline>]
    static member mouseEnter (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "mouseenter" (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseenter" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member mouseEnterView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "mouseenter" view (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseleave".
    [<JavaScript; Inline>]
    static member mouseLeave (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "mouseleave" (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseleave" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member mouseLeaveView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "mouseleave" view (FSharpConvert.Fun f)
    /// Create a handler for the event "mousemove".
    [<JavaScript; Inline>]
    static member mouseMove (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "mousemove" (FSharpConvert.Fun f)
    /// Create a handler for the event "mousemove" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member mouseMoveView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "mousemove" view (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseout".
    [<JavaScript; Inline>]
    static member mouseOut (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "mouseout" (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseout" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member mouseOutView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "mouseout" view (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseover".
    [<JavaScript; Inline>]
    static member mouseOver (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "mouseover" (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseover" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member mouseOverView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "mouseover" view (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseup".
    [<JavaScript; Inline>]
    static member mouseUp (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "mouseup" (FSharpConvert.Fun f)
    /// Create a handler for the event "mouseup" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member mouseUpView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "mouseup" view (FSharpConvert.Fun f)
    /// Create a handler for the event "noupdate".
    [<JavaScript; Inline>]
    static member noUpdate (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "noupdate" (FSharpConvert.Fun f)
    /// Create a handler for the event "noupdate" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member noUpdateView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "noupdate" view (FSharpConvert.Fun f)
    /// Create a handler for the event "obsolete".
    [<JavaScript; Inline>]
    static member obsolete (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "obsolete" (FSharpConvert.Fun f)
    /// Create a handler for the event "obsolete" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member obsoleteView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "obsolete" view (FSharpConvert.Fun f)
    /// Create a handler for the event "offline".
    [<JavaScript; Inline>]
    static member offline (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "offline" (FSharpConvert.Fun f)
    /// Create a handler for the event "offline" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member offlineView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "offline" view (FSharpConvert.Fun f)
    /// Create a handler for the event "online".
    [<JavaScript; Inline>]
    static member online (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "online" (FSharpConvert.Fun f)
    /// Create a handler for the event "online" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member onlineView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "online" view (FSharpConvert.Fun f)
    /// Create a handler for the event "open".
    [<JavaScript; Inline>]
    static member ``open`` (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "open" (FSharpConvert.Fun f)
    /// Create a handler for the event "open" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member openView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "open" view (FSharpConvert.Fun f)
    /// Create a handler for the event "orientationchange".
    [<JavaScript; Inline>]
    static member orientationChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "orientationchange" (FSharpConvert.Fun f)
    /// Create a handler for the event "orientationchange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member orientationChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "orientationchange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "pagehide".
    [<JavaScript; Inline>]
    static member pageHide (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "pagehide" (FSharpConvert.Fun f)
    /// Create a handler for the event "pagehide" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member pageHideView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "pagehide" view (FSharpConvert.Fun f)
    /// Create a handler for the event "pageshow".
    [<JavaScript; Inline>]
    static member pageShow (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "pageshow" (FSharpConvert.Fun f)
    /// Create a handler for the event "pageshow" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member pageShowView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "pageshow" view (FSharpConvert.Fun f)
    /// Create a handler for the event "paste".
    [<JavaScript; Inline>]
    static member paste (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "paste" (FSharpConvert.Fun f)
    /// Create a handler for the event "paste" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member pasteView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "paste" view (FSharpConvert.Fun f)
    /// Create a handler for the event "pause".
    [<JavaScript; Inline>]
    static member pause (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "pause" (FSharpConvert.Fun f)
    /// Create a handler for the event "pause" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member pauseView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "pause" view (FSharpConvert.Fun f)
    /// Create a handler for the event "play".
    [<JavaScript; Inline>]
    static member play (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "play" (FSharpConvert.Fun f)
    /// Create a handler for the event "play" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member playView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "play" view (FSharpConvert.Fun f)
    /// Create a handler for the event "playing".
    [<JavaScript; Inline>]
    static member playing (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "playing" (FSharpConvert.Fun f)
    /// Create a handler for the event "playing" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member playingView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "playing" view (FSharpConvert.Fun f)
    /// Create a handler for the event "pointerlockchange".
    [<JavaScript; Inline>]
    static member pointerLockChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "pointerlockchange" (FSharpConvert.Fun f)
    /// Create a handler for the event "pointerlockchange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member pointerLockChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "pointerlockchange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "pointerlockerror".
    [<JavaScript; Inline>]
    static member pointerLockError (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "pointerlockerror" (FSharpConvert.Fun f)
    /// Create a handler for the event "pointerlockerror" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member pointerLockErrorView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "pointerlockerror" view (FSharpConvert.Fun f)
    /// Create a handler for the event "popstate".
    [<JavaScript; Inline>]
    static member popState (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "popstate" (FSharpConvert.Fun f)
    /// Create a handler for the event "popstate" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member popStateView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "popstate" view (FSharpConvert.Fun f)
    /// Create a handler for the event "progress".
    [<JavaScript; Inline>]
    static member progress (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "progress" (FSharpConvert.Fun f)
    /// Create a handler for the event "progress" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member progressView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "progress" view (FSharpConvert.Fun f)
    /// Create a handler for the event "ratechange".
    [<JavaScript; Inline>]
    static member rateChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "ratechange" (FSharpConvert.Fun f)
    /// Create a handler for the event "ratechange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member rateChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "ratechange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "readystatechange".
    [<JavaScript; Inline>]
    static member readyStateChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "readystatechange" (FSharpConvert.Fun f)
    /// Create a handler for the event "readystatechange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member readyStateChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "readystatechange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "repeatEvent".
    [<JavaScript; Inline>]
    static member repeatEvent (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "repeatEvent" (FSharpConvert.Fun f)
    /// Create a handler for the event "repeatEvent" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member repeatEventView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "repeatEvent" view (FSharpConvert.Fun f)
    /// Create a handler for the event "reset".
    [<JavaScript; Inline>]
    static member reset (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "reset" (FSharpConvert.Fun f)
    /// Create a handler for the event "reset" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member resetView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "reset" view (FSharpConvert.Fun f)
    /// Create a handler for the event "resize".
    [<JavaScript; Inline>]
    static member resize (f: System.Action<Dom.Element, Dom.UIEvent>) = Client.Attr.Handler "resize" (FSharpConvert.Fun f)
    /// Create a handler for the event "resize" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member resizeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.UIEvent, 'T>) = Client.Attr.HandlerView "resize" view (FSharpConvert.Fun f)
    /// Create a handler for the event "scroll".
    [<JavaScript; Inline>]
    static member scroll (f: System.Action<Dom.Element, Dom.UIEvent>) = Client.Attr.Handler "scroll" (FSharpConvert.Fun f)
    /// Create a handler for the event "scroll" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member scrollView (view: View<'T>) (f: System.Action<Dom.Element, Dom.UIEvent, 'T>) = Client.Attr.HandlerView "scroll" view (FSharpConvert.Fun f)
    /// Create a handler for the event "seeked".
    [<JavaScript; Inline>]
    static member seeked (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "seeked" (FSharpConvert.Fun f)
    /// Create a handler for the event "seeked" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member seekedView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "seeked" view (FSharpConvert.Fun f)
    /// Create a handler for the event "seeking".
    [<JavaScript; Inline>]
    static member seeking (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "seeking" (FSharpConvert.Fun f)
    /// Create a handler for the event "seeking" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member seekingView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "seeking" view (FSharpConvert.Fun f)
    /// Create a handler for the event "select".
    [<JavaScript; Inline>]
    static member select (f: System.Action<Dom.Element, Dom.UIEvent>) = Client.Attr.Handler "select" (FSharpConvert.Fun f)
    /// Create a handler for the event "select" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member selectView (view: View<'T>) (f: System.Action<Dom.Element, Dom.UIEvent, 'T>) = Client.Attr.HandlerView "select" view (FSharpConvert.Fun f)
    /// Create a handler for the event "show".
    [<JavaScript; Inline>]
    static member show (f: System.Action<Dom.Element, Dom.MouseEvent>) = Client.Attr.Handler "show" (FSharpConvert.Fun f)
    /// Create a handler for the event "show" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member showView (view: View<'T>) (f: System.Action<Dom.Element, Dom.MouseEvent, 'T>) = Client.Attr.HandlerView "show" view (FSharpConvert.Fun f)
    /// Create a handler for the event "stalled".
    [<JavaScript; Inline>]
    static member stalled (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "stalled" (FSharpConvert.Fun f)
    /// Create a handler for the event "stalled" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member stalledView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "stalled" view (FSharpConvert.Fun f)
    /// Create a handler for the event "storage".
    [<JavaScript; Inline>]
    static member storage (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "storage" (FSharpConvert.Fun f)
    /// Create a handler for the event "storage" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member storageView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "storage" view (FSharpConvert.Fun f)
    /// Create a handler for the event "submit".
    [<JavaScript; Inline>]
    static member submit (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "submit" (FSharpConvert.Fun f)
    /// Create a handler for the event "submit" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member submitView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "submit" view (FSharpConvert.Fun f)
    /// Create a handler for the event "success".
    [<JavaScript; Inline>]
    static member success (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "success" (FSharpConvert.Fun f)
    /// Create a handler for the event "success" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member successView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "success" view (FSharpConvert.Fun f)
    /// Create a handler for the event "suspend".
    [<JavaScript; Inline>]
    static member suspend (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "suspend" (FSharpConvert.Fun f)
    /// Create a handler for the event "suspend" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member suspendView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "suspend" view (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGAbort".
    [<JavaScript; Inline>]
    static member SVGAbort (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "SVGAbort" (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGAbort" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member SVGAbortView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "SVGAbort" view (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGError".
    [<JavaScript; Inline>]
    static member SVGError (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "SVGError" (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGError" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member SVGErrorView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "SVGError" view (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGLoad".
    [<JavaScript; Inline>]
    static member SVGLoad (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "SVGLoad" (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGLoad" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member SVGLoadView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "SVGLoad" view (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGResize".
    [<JavaScript; Inline>]
    static member SVGResize (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "SVGResize" (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGResize" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member SVGResizeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "SVGResize" view (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGScroll".
    [<JavaScript; Inline>]
    static member SVGScroll (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "SVGScroll" (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGScroll" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member SVGScrollView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "SVGScroll" view (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGUnload".
    [<JavaScript; Inline>]
    static member SVGUnload (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "SVGUnload" (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGUnload" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member SVGUnloadView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "SVGUnload" view (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGZoom".
    [<JavaScript; Inline>]
    static member SVGZoom (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "SVGZoom" (FSharpConvert.Fun f)
    /// Create a handler for the event "SVGZoom" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member SVGZoomView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "SVGZoom" view (FSharpConvert.Fun f)
    /// Create a handler for the event "timeout".
    [<JavaScript; Inline>]
    static member timeOut (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "timeout" (FSharpConvert.Fun f)
    /// Create a handler for the event "timeout" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member timeOutView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "timeout" view (FSharpConvert.Fun f)
    /// Create a handler for the event "timeupdate".
    [<JavaScript; Inline>]
    static member timeUpdate (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "timeupdate" (FSharpConvert.Fun f)
    /// Create a handler for the event "timeupdate" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member timeUpdateView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "timeupdate" view (FSharpConvert.Fun f)
    /// Create a handler for the event "touchcancel".
    [<JavaScript; Inline>]
    static member touchCancel (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "touchcancel" (FSharpConvert.Fun f)
    /// Create a handler for the event "touchcancel" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member touchCancelView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "touchcancel" view (FSharpConvert.Fun f)
    /// Create a handler for the event "touchend".
    [<JavaScript; Inline>]
    static member touchEnd (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "touchend" (FSharpConvert.Fun f)
    /// Create a handler for the event "touchend" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member touchEndView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "touchend" view (FSharpConvert.Fun f)
    /// Create a handler for the event "touchenter".
    [<JavaScript; Inline>]
    static member touchEnter (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "touchenter" (FSharpConvert.Fun f)
    /// Create a handler for the event "touchenter" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member touchEnterView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "touchenter" view (FSharpConvert.Fun f)
    /// Create a handler for the event "touchleave".
    [<JavaScript; Inline>]
    static member touchLeave (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "touchleave" (FSharpConvert.Fun f)
    /// Create a handler for the event "touchleave" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member touchLeaveView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "touchleave" view (FSharpConvert.Fun f)
    /// Create a handler for the event "touchmove".
    [<JavaScript; Inline>]
    static member touchMove (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "touchmove" (FSharpConvert.Fun f)
    /// Create a handler for the event "touchmove" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member touchMoveView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "touchmove" view (FSharpConvert.Fun f)
    /// Create a handler for the event "touchstart".
    [<JavaScript; Inline>]
    static member touchStart (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "touchstart" (FSharpConvert.Fun f)
    /// Create a handler for the event "touchstart" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member touchStartView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "touchstart" view (FSharpConvert.Fun f)
    /// Create a handler for the event "transitionend".
    [<JavaScript; Inline>]
    static member transitionEnd (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "transitionend" (FSharpConvert.Fun f)
    /// Create a handler for the event "transitionend" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member transitionEndView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "transitionend" view (FSharpConvert.Fun f)
    /// Create a handler for the event "unload".
    [<JavaScript; Inline>]
    static member unload (f: System.Action<Dom.Element, Dom.UIEvent>) = Client.Attr.Handler "unload" (FSharpConvert.Fun f)
    /// Create a handler for the event "unload" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member unloadView (view: View<'T>) (f: System.Action<Dom.Element, Dom.UIEvent, 'T>) = Client.Attr.HandlerView "unload" view (FSharpConvert.Fun f)
    /// Create a handler for the event "updateready".
    [<JavaScript; Inline>]
    static member updateReady (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "updateready" (FSharpConvert.Fun f)
    /// Create a handler for the event "updateready" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member updateReadyView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "updateready" view (FSharpConvert.Fun f)
    /// Create a handler for the event "upgradeneeded".
    [<JavaScript; Inline>]
    static member upgradeNeeded (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "upgradeneeded" (FSharpConvert.Fun f)
    /// Create a handler for the event "upgradeneeded" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member upgradeNeededView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "upgradeneeded" view (FSharpConvert.Fun f)
    /// Create a handler for the event "userproximity".
    [<JavaScript; Inline>]
    static member userProximity (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "userproximity" (FSharpConvert.Fun f)
    /// Create a handler for the event "userproximity" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member userProximityView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "userproximity" view (FSharpConvert.Fun f)
    /// Create a handler for the event "versionchange".
    [<JavaScript; Inline>]
    static member versionChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "versionchange" (FSharpConvert.Fun f)
    /// Create a handler for the event "versionchange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member versionChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "versionchange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "visibilitychange".
    [<JavaScript; Inline>]
    static member visibilityChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "visibilitychange" (FSharpConvert.Fun f)
    /// Create a handler for the event "visibilitychange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member visibilityChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "visibilitychange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "volumechange".
    [<JavaScript; Inline>]
    static member volumeChange (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "volumechange" (FSharpConvert.Fun f)
    /// Create a handler for the event "volumechange" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member volumeChangeView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "volumechange" view (FSharpConvert.Fun f)
    /// Create a handler for the event "waiting".
    [<JavaScript; Inline>]
    static member waiting (f: System.Action<Dom.Element, Dom.Event>) = Client.Attr.Handler "waiting" (FSharpConvert.Fun f)
    /// Create a handler for the event "waiting" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member waitingView (view: View<'T>) (f: System.Action<Dom.Element, Dom.Event, 'T>) = Client.Attr.HandlerView "waiting" view (FSharpConvert.Fun f)
    /// Create a handler for the event "wheel".
    [<JavaScript; Inline>]
    static member wheel (f: System.Action<Dom.Element, Dom.WheelEvent>) = Client.Attr.Handler "wheel" (FSharpConvert.Fun f)
    /// Create a handler for the event "wheel" which also receives the value of a view at the time of the event.
    [<JavaScript; Inline>]
    static member wheelView (view: View<'T>) (f: System.Action<Dom.Element, Dom.WheelEvent, 'T>) = Client.Attr.HandlerView "wheel" view (FSharpConvert.Fun f)
    // }}
