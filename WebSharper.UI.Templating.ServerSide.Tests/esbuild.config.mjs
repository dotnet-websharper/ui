...
const prebundles = readdirSync('./build/Scripts/WebSharper/WebSharper.UI.Templating.ServerSide.Tests/');

prebundles.forEach(file => {
  if (file.endsWith('.js')) {
    var options =
    {
      entryPoints: ['./wwwroot/Scripts/WebSharper/WebSharper.UI.Templating.ServerSide.Tests/' + file],
      bundle: true,
      minify: true,
      format: 'iife',
